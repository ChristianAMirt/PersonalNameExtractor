...
import java.nio.file.Path;public class TestPNE {
    ...
    @Test
    public void testKillWordFeature() throws IOException{
        Path inputPath = Path.of("src/systemTest/data/test008/test.dat");
        String input = Files.readString(inputPath);

        Path expectedPath = Path.of("src/systemTest/data/test008/test.expected");
        String expected = Files.readString(expectedPath);
        ...
        BufferedWriter output = new BufferedWriter(new FileWriter("src/systemTest/data/test008/test.out"));
        output.append(outputStream.toString());
        output.close();
    ...
    @Test
    public void testPrefixAndSuffixFeature() throws IOException{
        Path inputPath = Path.of("src/systemTest/data/test009/test.dat");
        String input = Files.readString(inputPath);

        Path expectedPath = Path.of("src/systemTest/data/test009/test.expected");
        String expected = Files.readString(expectedPath);
        ...
        BufferedWriter output = new BufferedWriter(new FileWriter("src/systemTest/data/test009/test.out"));
        output.append(outputStream.toString());
        output.close();
